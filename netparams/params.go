...
// SatsMainNetParams contains parameters specific running btcwallet and
// btcd on the test network (version 4) (wire.SatsMainNetParams).
var SatsMainNetParams = Params{
	Params:        &chaincfg.SatsMainNetParams,
	RPCClientPort: "4827", // btcd rpc port
	RPCServerPort: "4828", // wallet rpc port
}
...
var SatsTestNetParams = Params{
	...
	RPCClientPort: "14827", // btcd rpc port
	RPCServerPort: "14828", // wallet rpc port
}
