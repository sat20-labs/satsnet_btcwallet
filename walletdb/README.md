...
[![GoDoc](https://godoc.org/github.com/sat20-labs/satsnet_btcwallet/walletdb?status.png)]
(http://godoc.org/github.com/sat20-labs/satsnet_btcwallet/walletdb)
...
http://localhost:6060/pkg/github.com/sat20-labs/satsnet_btcwallet/walletdb

## Installation

```bash
$ go get github.com/sat20-labs/satsnet_btcwallet/walletdb
```

## Examples

* [Basic Usage Example]
  (http://godoc.org/github.com/sat20-labs/satsnet_btcwallet/walletdb#example-package--BasicUsage)  
